                            ...
                            <tbody className="bg-slate-100 divide-y divide-slate-300">
                                {records.map(r => (
                                    <tr key={r.id}>
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{r.companyId}</td>
                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{formatDate(r.startDate)}</td>
                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{formatDate(r.endDate)}</td>
