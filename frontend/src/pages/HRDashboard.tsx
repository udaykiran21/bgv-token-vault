                ...
                <div className="bg-white shadow rounded-lg overflow-hidden flex flex-col">
                    <div className="px-4 py-5 sm:p-6 flex-grow">
                        ...
                        <div className="mt-5">
                            ...
                            <input type="text" value={candidateAddr} onChange={e => setCandidateAddr(e.target.value)} className="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md py-2 px-3 border" />
                    ...
                    <div className="px-4 py-5 sm:p-6 flex-grow">
                        ...
                        <div className="mt-5 space-y-4">
                            <div>
                                ...
                                <input type="number" placeholder="e.g. 1" value={recordIdFinalize} onChange={e => setRecordIdFinalize(e.target.value)} className="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md py-2 px-3 border" />
                            </div>
                            <div>
                                <label className="block text-sm font-medium text-gray-700">Relieving Document</label>
                                <input type="file" onChange={e => setFile(e.target.files ? e.target.files[0] : null)} className="mt-1 block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100" />
                            </div>
                        </div>
                    </div>
                    <div className="bg-gray-50 px-4 py-4 sm:px-6">
                ...
                <div className="px-4 py-5 sm:p-6">
                    ...
                    <div className="mt-5 flex gap-4 items-end">
                        <div className="flex-grow max-w-xs">
                            <label className="block text-sm font-medium text-gray-700">Record ID</label>
                            <input type="number" placeholder="e.g. 1" value={recordIdVerify} onChange={e => setRecordIdVerify(e.target.value)} className="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md py-2 px-3 border" />
                        </div>
                        <button onClick={handleVerifyRecord} className="inline-flex justify-center py-2 px-6 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 h-[38px]">
                            Verify
                        </button>
                    </div>
                        ...
                        <div className="mt-8 border-t border-gray-200 pt-6">
                            ...
                            <dl className="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2">
                                ...
                                <div className="sm:col-span-2">
                                    ...
                                    <dd className="mt-1 text-sm text-gray-900 font-mono break-all bg-gray-50 p-2 rounded border border-gray-200">{verifiedData.documentHash || "Not finalized yet"}</dd>
                                </div>
                            </dl>
